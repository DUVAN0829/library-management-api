...
import co.duvan.prestamo.infrastructure.adapters.output.persistence.mapper.LoanPersitenceMapper;
import co.duvan.prestamo.infrastructure.adapters.output.persistence.repository.LoanRepository;
